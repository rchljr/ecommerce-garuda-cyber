        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function renderCheckoutPage(data) {
                ...
                data.shopsData.forEach(shopData => {
                    ...
                    checkoutState.shops[shopId] = { subtotal: shopData.subtotal, shippingCost: 0, shippingService: '', voucherId: null, voucherCode: '', voucherDiscount: 0 };
                    let itemsHTML = '';
            ...
            function handlePaymentResponse(data) {
                let html = '';
                // Ganti seluruh konten wrapper dengan instruksi pembayaran
            ...
            function addEventListeners() {
                ...
                document.getElementById('checkout-form').addEventListener('submit', e => {
                    ...
                    // PERBAIKAN: Validasi pengiriman ditambahkan di sini

        ...
        <div class="max-w-md w-full space-y-8 bg-white p-10 rounded-xl shadow-lg">
            <div>
                ...
                <p class="mt-2 text-center text-sm text-gray-600">
                    Sudah punya akun? <a
                        href="{{ route('tenant.customer.login.form', ['subdomain' => request()->route('subdomain')]) }}"
                        class="font-medium text-gray-800 hover:text-black">Login di sini</a>
                </p>
            </div>
            <form class="mt-8 space-y-4"
                action="{{ route('tenant.customer.register.submit', ['subdomain' => request()->route('subdomain')]) }}"
                method="POST">
                @csrf
                <div>
                ...
                <div>
                    ...
                    {{-- PERBAIKAN: Menambahkan div.relative dan tombol ikon --}}
                    <div class="mt-1 relative">
                        ...
                        <button type="button"
                            ...
                            <svg class="eye-icon h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"

                            ...
                            <div class="space-y-6">
                                <div>
                                    ...
                                    <input type="text" name="name" id="name" value="{{ old('name', $user->name) }}"
                                        class="mt-1 block w-full h-[40px] border-2 border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500">
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <textarea name="alamat" id="alamat" rows="4"
                                        class="mt-1 block w-full border-2 border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500">{{ old('alamat', $user->alamat) }}</textarea>
                                </div>
                                <div>
                                    ...
                                    <div class="mt-1 flex items-center">
                                        ...
                                        <label for="photo"
                                            class="ml-5 bg-white py-2 px-3 border border-gray-300 rounded-md shadow-sm text-sm leading-4 font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 cursor-pointer">
                                            Pilih Gambar
                                        </label>
                                    </div>

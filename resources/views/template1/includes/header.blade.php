                        ...
                        <div class="header__top__links">
                            ...
                            @auth
                                ...
                                <div class="header__top__dropdown">
                                    ...
                                    <ul>
                                        <li><a href="{{ route('customer.profile') }}">Akun Saya</a></li>
                                        ...
                                        <li>
                                            ...
                                            <form id="logout-form-header" action="{{ route('customer.logout') }}"
                ...
                <nav class="header__menu mobile-menu">
                    <ul>
                        ...
                        <li class="{{ request()->routeIs('contact') ? 'active' : '' }}"><a
                                href="{{ route('contact') }}">Tentang Kami</a></li>
                    </ul>
                </nav>
            </div>
            <div class="col-lg-3 col-md-3">
                <div class="header__nav__option">
                    <a href="#" class="search-switch"><img src="{{ asset('template1/img/icon/search.png') }}"
                            alt=""></a>
                    <a href="{{ route('wishlist.index') }}"><img src="{{ asset('template1/img/icon/heart.png') }}"
                            alt=""></a>
                    {{-- Diperbarui untuk menampilkan hitungan dari session --}}
                    <a href="{{ route('cart.index') }}"><img src="{{ asset('template1/img/icon/cart.png') }}" alt="">
                        <span
                            id="cart-count">{{ Session::has('cart') ? array_sum(array_column(Session::get('cart'), 'quantity')) : 0 }}</span></a>
                </div>
            </div>
        </div>

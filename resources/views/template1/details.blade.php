...
@push('styles')
    ...
    <style>
        ...
        .product_detailsbtns_option .toggle-wishlist.active i,
        ...
        .product_details_option .option-select-group {
            margin-bottom: 15px;
        }

        .product_details_option .option-select-group select {
            width: 100%;
            height: 46px;
        ...
        .product_details_option .option-select-group select:disabled {
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="product_details_text">
                            ...
                            <div class="product_detailslast_option">
                    ...
                    @foreach ($relatedProducts as $relatedProduct)
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="product__item">
                                <div class="product_item_pic set-bg" data-setbg="{{ $relatedProduct->image_url }}">

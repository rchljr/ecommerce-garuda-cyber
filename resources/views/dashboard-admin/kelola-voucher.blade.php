...
@section('content')
                ...
                @forelse($vouchers as $voucher)
                    <tr class="text-gray-700 text-center">
                        ...
                        <td class="px-6 py-4">
                            ...
                            @endphp
                            <span class="px-3 py-1 text-sm font-semibold rounded-full {{ $statusClass }}">{{ $status }}</span>
                        </td>
    ...
    <div id="voucher-modal" class="hidden fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
        <div class="relative top-10 mx-auto p-5 border w-full max-w-2xl shadow-lg rounded-md bg-white">
            ...
            <form id="voucher-form" class="mt-4 space-y-4" data-store-url="{{ route('admin.voucher.store') }}"
                ...
                <div>
                    ...
                    <input type="text" id="voucher_code" name="voucher_code"
                        ...
                        placeholder="Contoh: GAJIANSERU" required>
                ...
                <div>
                    ...
                    <textarea id="description" name="description"
                        ...
                        rows="2" placeholder="Contoh: Diskon spesial hari gajian"></textarea>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" id="discount" name="discount"
                            class="block w-full h-12 px-4 border-2 border-gray-300 rounded-lg focus:border-red-600 focus:ring-0 transition"
                            placeholder="Contoh: 10" required min="1">
                    ...
                    <div>
                        ...
                        <input type="number" id="min_spending" name="min_spending"
                            class="block w-full h-12 px-4 border-2 border-gray-300 rounded-lg focus:border-red-600 focus:ring-0 transition"
                            min="0" value="0" placeholder="Contoh: 50000">
                    </div>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
...
@push('scripts')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            // ... (sisa JavaScript Anda tetap sama)

...
@section('content')
    <div>
        ...
        <div class="flex flex-col lg:flex-row gap-8 items-start">
            ...
            <div class="flex flex-col gap-8 w-full lg:w-auto">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-8">
                    <a href="{{ route('admin.pendapatan.index') }}">
                        <div
                            class="bg-white p-6 rounded-2xl shadow-lg w-full h-40 flex flex-col justify-between hover:shadow-xl transition-shadow">
                            <div class="text-base font-bold text-gray-600">Pendapatan Bulan Ini</div>
                            <div class="text-3xl font-bold text-green-500">{{ format_rupiah($totalPendapatanPerBulan) }}
                            </div>
                            <div class="text-sm text-gray-500">Total lunas di bulan {{ format_tanggal(now(), 'MMMM') }}
                            </div>
                        </div>
                    </a>
                    <a href="{{ route('admin.pendapatan.index') }}">
                        <div
                            ...
                            <div class="text-3xl font-bold text-green-500">{{ format_rupiah($totalPendapatanPerTahun) }}
                            </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-8">
                    <a href="{{route('admin.mitra.verifikasi')}}">
                        <div
                            ...
                            <div class="text-3xl font-bold text-[#FFC738]">
                                {{ number_format($jumlahMitraPerluVerifikasi) }}
                            </div>
                    ...
                    <a href="{{ route('admin.mitra.kelola') }}">
                        <div
                            class="bg-white p-6 rounded-2xl shadow-lg w-full h-40 flex flex-col justify-between hover:shadow-xl transition-shadow">
                            <div class="text-base font-bold text-gray-600">Total Mitra Baru Bulan Ini</div>
                            <div class="text-3xl font-bold text-[#FFC738]">{{ number_format($jumlahMitraBaruBulanIni) }}
                            </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-8">
                    <a href="{{ route('admin.mitra.kelola') }}">
                        <div
                            ...
                            <div class="text-3xl font-bold text-[#4D80ED]">{{ number_format($jumlahSeluruhAkunMitra) }}
                            </div>
                            <div class="text-sm text-gray-500">Total mitra aktif saat ini</div>
                        </div>
                    </a>
            ...
            <!-- Kolom Chart -->
            <div
                class="flex-1 bg-white p-6 rounded-2xl shadow-lg flex flex-col min-w-[300px] lg:min-w-[500px] h-96 w-full lg:w-auto">

            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-8">
                <a href="{{route('admin.mitra.verifikasi')}}">
                    <div
                        ...
                        <div class="text-3xl font-bold text-[#FFC738]">{{ number_format($jumlahMitraPerluVerifikasi) }}
                        </div>
                ...
                <a href="{{ route('admin.mitra.kelola') }}">
                    <div
                        ...
                        <div class="text-3xl font-bold text-[#FFC738]">{{ number_format($jumlahMitraBaruBulanIni) }}</div>

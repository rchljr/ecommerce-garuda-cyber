...
<nav class="space-y-2">
    <a href="{{ route('customer.profile') }}"
        class="flex items-center px-4 py-2 rounded-lg font-semibold {{ request()->routeIs('customer.profile') ? 'bg-gray-800 text-white' : 'text-gray-600 hover:bg-gray-100' }}">
    ...
    <a href="{{ route('customer.orders') }}"
        class="flex items-center px-4 py-2 rounded-lg font-semibold {{ request()->routeIs('customer.orders') ? 'bg-gray-800 text-white' : 'text-gray-600 hover:bg-gray-100' }}">
        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <a href="{{ route('customer.notifications') }}"
        class="flex items-center px-4 py-2 rounded-lg font-semibold {{ request()->routeIs('customer.notifications') ? 'bg-gray-800 text-white' : 'text-gray-600 hover:bg-gray-100' }}">
        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <a href="{{ route('customer.vouchers') }}"
        class="flex items-center px-4 py-2 rounded-lg font-semibold {{ request()->routeIs('customer.vouchers') ? 'bg-gray-800 text-white' : 'text-gray-600 hover:bg-gray-100' }}">
        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    {{-- <a href="{{ route('customer.points') }}"
        class="flex items-center px-4 py-2 rounded-lg font-semibold {{ request()->routeIs('customer.points') ? 'bg-gray-800 text-white' : 'text-gray-600 hover:bg-gray-100' }}">
        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"

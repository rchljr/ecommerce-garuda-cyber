        ...
        <div class="grid md:grid-cols-3 lg:grid-cols-4 gap-8">
            ...
            <div class="col-span-full md:col-span-1 lg:col-span-2">
                ...
                <div class="flex">
                    ...
                    <button class="bg-red-600 text-white px-4 py-2 font-bold rounded-r-md hover:bg-red-700">GO!</button>
                </div>
                <div class="flex space-x-4 mt-6">
                    ...
                    <a href="#" class="text-gray-400 hover:text-white"><svg class="w-6 h-6" fill="currentColor"
                            viewBox="0 0 24 24" aria-hidden="true">
                            <path
                                d="M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 16c-2.21 0-4-1.79-4-4s1.79-4 4-4 4 1.79 4 4-1.79 4-4 4zm4-6.5c-.83 0-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5 1.5.67 1.5 1.5-.67 1.5-1.5 1.5z" />
                        </svg></a>
                    <a href="#" class="text-gray-400 hover:text-white"><svg class="w-6 h-6" fill="currentColor"
                            viewBox="0 0 24 24" aria-hidden="true">
                            <path

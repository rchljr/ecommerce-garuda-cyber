        ...
        <div class="grid md:grid-cols-3 lg:grid-cols-4 gap-8">
            ...
            <div class="col-span-full md:col-span-1 lg:col-span-2">
                ...
                <form action="#" method="" class="flex">
                    ...
                    <button type="submit"
                        class="bg-red-600 text-white px-4 py-2 font-bold rounded-r-md hover:bg-red-700">GO!</button>
                </form>
                <div class="flex space-x-4 mt-6">
                    <a href="https://www.facebook.com/GarudaCyber/?locale=id_ID" target="_blank" rel="noopener noreferrer"
                        class="text-gray-400 hover:text-white" title="Facebook"><svg class="w-6 h-6" fill="currentColor"
                    ...
                    <a href="https://www.linkedin.com/company/garuda-cyber-indonesia/posts/?feedView=all" target="_blank" rel="noopener noreferrer"
                        class="text-gray-400 hover:text-white" title="LinkedIn"><svg class="w-6 h-6" fill="currentColor"
                            viewBox="0 0 24 24" aria-hidden="true">
                            <path

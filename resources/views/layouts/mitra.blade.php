...
<head>
    ...
    <title>@yield('title', 'Admin Dashboard') - E-Commerce Mitra Garuda Cyber</title>
            ...
            <main class="flex-1 bg-white p-8 relative overflow-x-auto">
                <div class="absolute inset-0 z-0 pointer-events-none" aria-hidden="true">
                    <div class="absolute bottom-0 -right-20 w-96 h-96">
                        <img src="{{ asset('images/bg-nav.png') }}" alt="Dekoratif" class="w-full h-full object-cover opacity-75">
                    </div>
                </div>

<section id="tema" class="py-16 md:py-24">
    <div class="container mx-auto px-6">
        <div class="text-center mb-12">
            <h3 class="text-5xl font-bold text-gray-900">Tema Toko Online Anda</h3>
        </div>
        <div class="border-2 border-red-300 rounded-3xl p-4 md:p-8">
            ...
            <div class="flex justify-center mt-8 space-x-4">
                <button id="tema-prev-btn" class="w-10 h-10 flex items-center justify-center border border-red-300 rounded-full hover:bg-red-100">
                ...
                <button id="tema-next-btn" class="w-10 h-10 flex items-center justify-center border border-yellow-400 bg-white rounded-full hover:bg-yellow-50">
                    <svg class="w-5 h-5 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                        xmlns="http://www.w3.org/2000/svg">

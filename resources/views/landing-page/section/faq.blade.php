        ...
        <div class="space-y-4">
            ...
            <div class="faq-item bg-white border border-gray-200 rounded-lg overflow-hidden">
                <div class="faq-question p-5 flex justify-between items-center cursor-pointer">
                    <h4 class="font-semibold text-gray-800">Apa itu E-Commerce Garuda?</h4>
                    <span
            ...
            <div class="faq-item bg-white border border-gray-200 rounded-lg overflow-hidden">
                <div class="faq-question p-5 flex justify-between items-center cursor-pointer">
                    <h4 class="font-semibold text-gray-800">Apa keuntungan utama bergabung dengan E-Commerce Garuda?
                    </h4>
                    <span
                        class="faq-icon text-gray-500 font-bold text-xl transition-transform duration-300 transform">+</span>
                </div>
            ...
            <div class="faq-item bg-white border border-gray-200 rounded-lg overflow-hidden">
                ...
                <div class="faq-answer hidden p-5 border-t border-gray-200 text-gray-600">
                    <p>Cukup klik tombol "Daftar" di bagian atas halaman, pilih paket yang sesuai dengan kebutuhan
                        bisnis Anda, dan ikuti langkah-langkah pendaftaran. Prosesnya cepat dan dirancang untuk memandu
                        Anda hingga toko Anda siap diluncurkan.</p>
                </div>
            </div>
        </div>

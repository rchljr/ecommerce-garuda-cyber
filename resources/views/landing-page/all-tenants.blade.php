                                ...
                                <div
                                    ...
                                    <a href="{{ route('tenant.home', ['subdomain' => $subdomain->subdomain_name]) }}"
                                        ...
                                        <div class="p-5 pt-12 flex flex-col flex-grow">
                                            <h3 class="font-bold text-lg text-gray-900 truncate" title="{{ $shop->shop_name }}">
                                                {{ $shop->shop_name }}</h3>
                                            ...
                                            @if($vouchers->isNotEmpty())
                                                <div class="mt-4 space-y-2">
                                                    ...
                                                    @foreach($vouchers->take(2) as $voucher)
                                                        <div
                                                            class="voucher-strip border-red-400 border-2 rounded-lg p-2 flex items-center gap-2 bg-red-50">
                                                            <svg class="w-6 h-6 text-red-500 flex-shrink-0" xmlns="http://www.w3.org/2000/svg"
                                                            ...
                                                            <div class="text-xs">
                                                                ...
                                                                @else
                                                                    <p class="font-semibold text-red-700">Diskon Rp
                                                                        {{ number_format($voucher->discount, 0, ',', '.') }}</p>
                                                                @endif
                                                                <p class="text-red-600">Min. belanja Rp
                                                                    {{ number_format($voucher->min_spending, 0, ',', '.') }}</p>
                                                            </div>
                                                        </div>
                                                    @endforeach
                                                </div>

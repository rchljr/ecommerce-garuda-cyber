...
<div class="w-full max-w-4xl mx-auto">
    ...
    <div class="mt-8 relative">
        <div
            class="flex items-center rounded-xl shadow-lg border-2 border-gray-200 focus-within:border-red-500 focus-within:ring-2 focus-within:ring-red-200 transition-all duration-300 h-14 md:h-16 overflow-hidden">
            <span
                class="bg-gray-100 h-full flex items-center text-gray-500 text-sm md:text-lg px-3 md:px-4 whitespace-nowrap border-r-2 border-gray-200">ecommercegaruda.my.id/tenant/</span>
            <input type="text" id="subdomain-input" placeholder="toko-baju-keren"
                class="w-full h-full px-4 md:px-5 text-base md:text-lg font-semibold text-gray-800 bg-white border-none focus:ring-0"
                                    ...
                                    <div class="bg-green-50 border-2 border-green-200 rounded-xl p-4 transition-all duration-300 animate-fade-in">
                                        <div class="flex flex-col sm:flex-row sm:items-center sm:gap-3">
                                            <div class="flex items-center gap-3 w-full sm:w-auto">
                                                ...
                                                <div class="flex-grow">
                                                    <p class="font-bold text-green-800">Nama Toko Tersedia!</p>
                                                    <p class="text-sm text-green-700 break-all">ecommercegaruda.my.id/tenant/${normalizedSubdomain}</p>
                                                </div>
                                            </div>
                                    ...
                                    <div class="bg-red-50 border-2 border-red-200 rounded-xl p-4 transition-all duration-300 animate-fade-in">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div class="flex-grow">
                                                ...
                                                <p class="text-sm text-red-700">${data.message || 'Nama ini sudah digunakan.'}</p>
                                            </div>
                                        </div>
                                        ${suggestionsHtml}
                                    </div>

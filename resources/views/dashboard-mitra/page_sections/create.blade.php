...
<div class="container mx-auto px-4 py-8">
    ...
    <form action="{{ route('mitra.pages.sections.store', $page) }}" method="POST" enctype="multipart/form-data"
        class="bg-white shadow-md rounded-lg p-6">
        @csrf

        <div class="mb-4">
            <label for="section_type" class="block text-gray-700 text-sm font-bold mb-2">Tipe Seksi <span
        ...
        <div class="mb-4">
            ...
            <input type="number" name="order" id="order"
                ...
                value="{{ old('order', $page->sections->max('order') + 1) }}">
            @error('order')
                <p class="text-red-500 text-xs italic mt-2">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div class="mb-4 flex items-center">
            ...
            <input type="checkbox" name="is_active" id="is_active" class="form-checkbox h-5 w-5 text-blue-600" value="1"
        ...
        <div class="flex items-center justify-between mt-6">
            ...
            <a href="{{ route('mitra.pages.sections.index', $page) }}"

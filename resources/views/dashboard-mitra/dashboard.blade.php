...
<style>
    .chart-container {
        position: relative;
        height: 350px; /* Atur tinggi default canvas */
        width: 100%;
    }
</style>
@endpush
                    ...
                    <table class="w-full text-sm text-left text-gray-500">
                        ...
                        <tbody>
                            ...
                            <tr class="border-b hover:bg-gray-50">
                                ...
                                <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap">{{ Str::limit($product->name, 25) }}</td>
                                <td class="px-4 py-3 text-center font-bold">{{ $product->sold_count }}</td>
                            </tr>
                            @empty
                            <tr>
                                <td colspan="3" class="text-center py-10 text-gray-500">Belum ada produk yang terjual.</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>

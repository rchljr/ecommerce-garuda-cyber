...
@section('title', 'Edit Item Hero')

@section('content')
<div class="bg-white shadow-xl rounded-xl p-6 sm:p-8 md:p-10 max-w-screen-md w-full mx-auto">
    <h1 class="text-3xl font-extrabold text-gray-900 mb-8 text-center">Edit Item Hero: {{ $hero->title }}</h1>
    ...
    <form action="{{ route('mitra.heroes.update', $hero->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            ...
            <div>
                ...
                <input type="text" name="button_text" id="button_text" value="{{ old('button_text', $hero->button_text) }}"
            ...
            <div class="md:col-span-2">
                ...
                <input type="url" name="button_url" id="button_url" value="{{ old('button_url', $hero->button_url) }}"
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="description" id="description" rows="4"
                          ...
                          placeholder="A specialist label creating luxury essentials...">{{ old('description', $hero->description) }}</textarea>
                @error('description')
                    <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="md:col-span-2">
                ...
                @if ($hero->image_url)
                    <div class="mb-4">
                        <img src="{{ $hero->image_url }}" alt="Current Hero Image" class="max-w-xs h-auto rounded-lg shadow-md border border-gray-200">
            ...
            <div class="flex items-center mt-6 md:mt-0">
                ...
                <input type="checkbox" name="is_active" id="is_active" value="1" class="h-5 w-5 text-blue-600 border-gray-300 rounded focus:ring-blue-500" {{ old('is_active', $hero->is_active) ? 'checked' : '' }}>

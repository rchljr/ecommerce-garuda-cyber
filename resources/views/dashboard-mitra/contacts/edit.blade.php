    ...
    <form action="{{ route('mitra.contacts.update') }}" method="POST">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            ...
            <div class="col-span-1 md:col-span-2">
                <label for="address_line1" class="block text-sm font-semibold text-gray-700 mb-1">Alamat Baris 1:</label>
                <input type="text" name="address_line1" id="address_line1" value="{{ old('address_line1', $contact->address_line1) }}"
            ...
            <!-- Address Line 2 -->
            <div class="col-span-1 md:col-span-2">
                <label for="address_line2" class="block text-sm font-semibold text-gray-700 mb-1">Alamat Baris 2 (Opsional):</label>
                <input type="text" name="address_line2" id="address_line2" value="{{ old('address_line2', $contact->address_line2) }}"
            ...
            <div>
                ...
                <input type="text" name="postal_code" id="postal_code" value="{{ old('postal_code', $contact->postal_code) }}"
            ...
            <div class="col-span-1 md:col-span-2 mt-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="url" name="facebook_url" id="facebook_url" value="{{ old('facebook_url', $contact->facebook_url) }}"
                    ...
                    <div>
                        <label for="twitter_url" class="block text-sm font-semibold text-gray-700 mb-1">Twitter URL:</label>
                        <input type="url" name="twitter_url" id="twitter_url" value="{{ old('twitter_url', $contact->twitter_url) }}"
                    ...
                    <div>
                        ...
                        <input type="url" name="instagram_url" id="instagram_url" value="{{ old('instagram_url', $contact->instagram_url) }}"
                    ...
                    <div>
                        <label for="pinterest_url" class="block text-sm font-semibold text-gray-700 mb-1">Pinterest URL:</label>
                        <input type="url" name="pinterest_url" id="pinterest_url" value="{{ old('pinterest_url', $contact->pinterest_url) }}"
            ...
            <!-- Map Embed Code -->
            <div class="col-span-1 md:col-span-2">
                <label for="map_embed_code" class="block text-sm font-semibold text-gray-700 mb-1">Kode Embed Peta (Iframe Google Maps):</label>
                ...
                <p class="mt-2 text-sm text-gray-500">Anda bisa mendapatkan kode ini dari Google Maps, klik 'Share' -> 'Embed a map' -> 'COPY HTML'.</p>

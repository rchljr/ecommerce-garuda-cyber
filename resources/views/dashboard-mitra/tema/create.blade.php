                    ...
                    <div>
                        ...
                        <div class="mt-1 flex items-center">
                            @if(optional($tema)->shop_logo) {{-- Gunakan optional() di sini --}}
                                <img src="{{ asset('storage/' . $tema->shop_logo) }}" alt="Logo Saat Ini" class="h-16 w-16 rounded-full object-cover border border-gray-200 shadow-sm">
                            @else
                                <span class="inline-block h-16 w-16 rounded-full overflow-hidden bg-gray-100 border border-gray-200 shadow-sm">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="color" id="primary_color" name="primary_color"
                                ...
                                class="mt-1 h-10 w-full block border border-gray-300 rounded-md cursor-pointer"> {{-- Tambahkan cursor-pointer --}}

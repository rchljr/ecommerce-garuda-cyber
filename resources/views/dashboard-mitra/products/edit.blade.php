            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="bg-white p-6 rounded-lg shadow">
                        ...
                        <div class="mb-4">
                            <label for="main_image" class="block text-sm font-medium text-gray-700 mb-1">Ganti Gambar Utama
                                (Opsional)</label>
                    ...
                    <div class="bg-white p-6 rounded-lg shadow">
                        ...
                        <div id="variants-container">
                            @forelse($product->variants as $index => $variant)
                                <div
                                    class="variant-item grid grid-cols-1 md:grid-cols-4 gap-4 items-end border-b pb-4 mb-4">
                                    <div>
                            ...
                            @empty
                                ...
                                <div
                                    class="variant-item grid grid-cols-1 md:grid-cols-4 gap-4 items-end border-b pb-4 mb-4">
                                    <div><label class="block text-sm font-medium text-gray-700">Warna</label><input
                                            type="text" name="variants[0][color]"
                                            class="w-full border-gray-300 rounded-md shadow-sm mt-1"></div>
                                    <div><label class="block text-sm font-medium text-gray-700">Ukuran</label><input
                                            type="text" name="variants[0][size]"
                                            class="w-full border-gray-300 rounded-md shadow-sm mt-1"></div>
                                    <div><label class="block text-sm font-medium text-gray-700">Stok</label><input
                                            type="number" name="variants[0][stock]"
                                            class="w-full border-gray-300 rounded-md shadow-sm mt-1" min="0"></div>
                                    <button type="button"
                                        class="remove-variant-btn bg-red-500 text-white px-3 py-2 rounded-md hover:bg-red-600 text-sm">Hapus</button>
                                </div>
                            @endforelse

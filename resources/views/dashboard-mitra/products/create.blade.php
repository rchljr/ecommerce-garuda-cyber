            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white p-6 rounded-lg shadow">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="short_description" name="short_description" rows="3" class="w-full border-gray-300 rounded-md shadow-sm"></textarea>
                    </div>
                    <div>
                ...
                <div class="bg-white p-6 rounded-lg shadow">
                    ...
                    <div class="mb-4">
                        <label for="main_image" class="block text-sm font-medium text-gray-700 mb-1">Gambar Utama (Thumbnail)</label>
                    ...
                    <div>
                        <label for="gallery_images" class="block text-sm font-medium text-gray-700 mb-1">Galeri Gambar (Bisa pilih banyak)</label>
                    ...
                    <div id="variants-container">
                        ...
                        <div class="variant-item grid grid-cols-1 md:grid-cols-4 gap-4 items-end border-b pb-4 mb-4">
                            <div>
                                ...
                                <input type="text" name="variants[0][color]" placeholder="e.g., Merah" class="w-full border-gray-300 rounded-md shadow-sm mt-1">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Ukuran</label>
                                <input type="text" name="variants[0][size]" placeholder="e.g., XL" class="w-full border-gray-300 rounded-md shadow-sm mt-1">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Stok</label>
                                <input type="number" name="variants[0][stock]" placeholder="e.g., 50" class="w-full border-gray-300 rounded-md shadow-sm mt-1" min="0">
                            </div>
                ...
                <div class="bg-white p-6 rounded-lg shadow">
                    <h2 class="text-xl font-semibold mb-4">Harga & SKU</h2>
                     <div class="mb-4">
                        ...
                        <input type="number" id="price" name="price" class="w-full border-gray-300 rounded-md shadow-sm" required min="0">
                    </div>
                    <div>
                        <label for="sku" class="block text-sm font-medium text-gray-700 mb-1">SKU (Stock Keeping Unit)</label>
                        <input type="text" id="sku" name="sku" class="w-full border-gray-300 rounded-md shadow-sm">
                    </div>
                </div>
        ...
        input.addEventListener('change', function(event) {
            ...
            for (const file of files) {
                ...
                reader.onload = function(e) {
                    ...
                    wrapper.innerHTML = `<img src="${e.target.result}" class="image-preview"><span class="remove-image">&times;</span>`;
